...
const PatientProfileSetting = () => {
    ...
    const fetchData = async (params) => {
        ...
        await axios.get(`https://drfayazproject.onrender.com/api/userauth/${params.clientId}`, config)
            .then(response => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const response = await axios.put(`https://drfayazproject.onrender.com/api/userauth/${params.clientId}`, formData, config);
