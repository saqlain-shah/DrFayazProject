...
function AddEditMedicineModal({ closeModal, isOpen, onClose, selectedItem }) {
  ...
  const handleSubmit = async () => {
    try {
      ...
      if (selectedItem) {
        const deleteResponse = await fetch(`https://drfayazproject.onrender.com/api/medicine/${selectedItem._id}`, {
          method: 'DELETE',
        });
      ...
      const createResponse = await fetch('https://drfayazproject.onrender.com/api/medicine', {
        method: 'POST',
        headers: {
