...
agenda.on('ready', () => {
    ...
    agenda.every('25 11 * * *', 'manage slots'); // Runs daily at 11:05 AM
    agenda.start();
});
...
function setCors(req, res, next) {
    const allowedOrigins = ['https://dashboard.avicenahealthcare.com', 'https://www.avicenahealthcare.com','http://localhost:5173'];
